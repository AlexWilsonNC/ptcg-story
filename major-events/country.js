...
const natSelector2007 = document.querySelector('.open-country-nats2007');
const natSelector2006 = document.querySelector('.open-country-nats2006');
const natSelector2005 = document.querySelector('.open-country-nats2005');
const natSelector2004 = document.querySelector('.open-country-nats2004');
...
function showOtherNats2007() {

    document.querySelector('.hidden-nat2007-1').style.display = 'block';
    document.querySelector('.hidden-nat2007-2').style.display = 'block';
...
function showOtherNats2006() {

    document.querySelector('.hidden-nat2006-1').style.display = 'block';
    document.querySelector('.hidden-nat2006-2').style.display = 'block';
...
function showOtherNats2005() {

    document.querySelector('.hidden-nat2005-1').style.display = 'block';
    document.querySelector('.hidden-nat2005-2').style.display = 'block';
...
function showOtherNats2004() {

    document.querySelector('.hidden-nat2004-1').style.display = 'block';
    document.querySelector('.hidden-nat2004-2').style.display = 'block';
