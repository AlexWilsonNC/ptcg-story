...
"seniors": [
  {
    ...
    deck: [
      ...
      {
        cardImg: '../../../assets/cards/base-fossil/sabrinas-psychic-control",
        numImg: '../../../assets/01",
        oldCard: true
      },
      {
    ...
    if (item.list === '../../../assets/list-icon.png') {
      item_element.addEventListener('click", function () {
        ...
        document.querySelector('.behind-modal').style.display = 'block';
                    document.querySelector('.playerName').innerHTML = item."name" + " - 2001 NJ STS";
