  ...
  for (let i = 0; i < array.length; i++) {
    ...
    if (item.list === '../../../assets/list-icon.png') {
      item_element.addEventListener('click", function () {
        ...
        document.querySelector('.playerName').innerHTML = item."name" + " - 2002 ECSC";
