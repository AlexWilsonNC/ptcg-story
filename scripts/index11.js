...
const deckbuild300 = document.querySelector('.deckbuild300');
...
function changeToBuild300() {
    deckbuild300.classList.add('dark-bg');
    deckbuild400.classList.remove('dark-bg');
    deckbuild400.classList.add('light-bg');

    buildBox300.style.display = 'flex';
    buildBox400.style.display = 'none';
    descBox300.style.display = 'flex';
    descBox400.style.display = 'none';
}
function changeToBuild400() {
    deckbuild400.classList.add('dark-bg');
    deckbuild300.classList.remove('dark-bg');
    deckbuild300.classList.add('light-bg');

    buildBox400.style.display = 'flex';
    buildBox300.style.display = 'none';
    descBox300.style.display = 'none';
    descBox400.style.display = 'flex';
}
