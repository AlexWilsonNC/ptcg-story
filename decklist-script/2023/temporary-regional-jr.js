const masterList = document.querySelector('.juniors-ol');
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        if (item.list.includes('./assets/list-icon.png')) {
            ...
            listIcon.addEventListener('click', function () {
                ...
                document.querySelector('.playerName').innerHTML = convertToTitleCase(item.firstName) + "<br><i>" + item.event + " - Juniors</i>";
                if (item.disclaimer) {
