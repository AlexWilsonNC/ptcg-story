let masters = [
    {
        ...
        "event": "2024 Stockholm Regionals",
        sprite1: '../../../../assets/sprites/snorlax.png',
        sprite2: '../../../../assets/sprites/rotom.png',
        list: '../../../../assets/list-icon.png',
        "decklist": {
            "pokemon": [
                {"count": 4, "name": "Snorlax", "set": "PGO", "number": "55"},
                {"count": 2, "name": "Rotom V", "set": "CRZ", "number": "45"},
                {"count": 2, "name": "Mimikyu", "set": "PAF", "number": "37"},
                {"count": 1, "name": "Sandshrew", "set": "MEW", "number": "27"},
                {"count": 1, "name": "Mantine", "set": "ASR", "number": "34"},
                {"count": 1, "name": "Chi-Yu ex", "set": "PAL", "number": "40"},
                {"count": 1, "name": "Pidgeot V", "set": "LOR", "number": "137"},
                        ],
            "trainer": [
                {"count": 4, "name": "Penny", "set": "SVI", "number": "183"},
                {"count": 4, "name": "Arven", "set": "OBF", "number": "186"},
                {"count": 3, "name": "Erika's Invitation", "set": "MEW", "number": "160"},
                {"count": 3, "name": "Eri", "set": "TEF", "number": "146"},
                {"count": 2, "name": "Miss Fortune Sisters", "set": "LOR", "number": "164"},
                ...
                {"count": 2, "name": "Defiance Vest", "set": "PAR", "number": "162"},
    ...
    },
    {
        ...
        "decklist": {
            ...
            "energy": [
                {"count": 4, "name": "Fire", "set": "Energy", "number": "2"},
