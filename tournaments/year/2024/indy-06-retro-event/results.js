let masters = [
    {
        ...
        "decklist": {
            "pokemon": [
                { "count": 4, "name": "Rocket's Sneasel ex", "set": "TRR", "number": "103" },
                { "count": 2, "name": "Dark Dragonite", "set": "TRR", "number": "15" },
                ...
                { "count": 1, "name": "Rocket's Hideout", "set": "TRR", "number": "87" },
            ], "energy": [
                { "count": 4, "name": "Darkness Energy", "set": "HP", "number": "94" },
                { "count": 4, "name": "Dark Metal Energy", "set": "TRR", "number": "94" },
                { "count": 4, "name": "R Energy", "set": "TRR", "number": "95" },
                { "count": 2, "name": "Rainbow Energy", "set": "LM", "number": "81" },
            ]
        }
    },
    {
    ...
    },
    {
        ...
        "decklist": {
            "pokemon": [
                ...
                { "count": 2, "name": "Larvitar δ", "set": "DS", "number": "73" },
                { "count": 1, "name": "Larvitar", "set": "TRR", "number": "63" },
                { "count": 2, "name": "Dark Ampharos", "set": "TRR", "number": "2" },
                { "count": 1, "name": "Dark Flaaffy", "set": "TRR", "number": "33" },
                { "count": 2, "name": "Mareep", "set": "TRR", "number": "67" },
                { "count": 2, "name": "Pidgeot", "set": "FL", "number": "10" },
                { "count": 1, "name": "Pidgeotto", "set": "FL", "number": "45" },
                { "count": 2, "name": "Pidgey", "set": "FL", "number": "73" },
                ...
                { "count": 4, "name": "Darkness Energy", "set": "HP", "number": "94" },
                { "count": 2, "name": "Double Rainbow Energy", "set": "EM", "number": "87" },
                { "count": 2, "name": "Scramble Energy", "set": "DF", "number": "89" },
                { "count": 2, "name": "Heal Energy", "set": "DX", "number": "94" },
            ]
        }
    },
    {
        ...
        "decklist": {
            "pokemon": [
                ...
                { "count": 4, "name": "Nidoran ♀", "set": "FL", "number": "70" },
                { "count": 3, "name": "Pidgeot", "set": "FL", "number": "10" },
                { "count": 1, "name": "Pidgeot δ", "set": "HP", "number": "14" },
                { "count": 2, "name": "Pidgeotto", "set": "FL", "number": "45" },
                { "count": 3, "name": "Pidgey", "set": "FL", "number": "73" },
                { "count": 1, "name": "Milotic", "set": "HL", "number": "12" },
                { "count": 1, "name": "Feebas", "set": "HL", "number": "61" },
                ...
                { "count": 2, "name": "Space Center", "set": "DX", "number": "91" },
            ], "energy": [
                { "count": 5, "name": "Grass Energy", "set": "HP", "number": "105" },
                { "count": 4, "name": "Double Rainbow Energy", "set": "EM", "number": "87" },
                {"count": 3, "name": "Holon Energy WP", "set": "DF", "number": "86"},
    ...
    },
    {
        ...
        "decklist": {
            "pokemon": [
                ...
                { "count": 1, "name": "Celebi ex", "set": "P2", "number": "17" },
                {"count": 1, "name": "Magcargo", "set": "DX", "number": "20"},
{"count": 1, "name": "Slugma", "set": "DX", "number": "74"},
{ "count": 2, "name": "Jirachi", "set": "HL", "number": "8" },
                { "count": 1, "name": "Jirachi", "set": "DX", "number": "9" },
                { "count": 1, "name": "Aipom", "set": "UF", "number": "34" },
    ...
    },
    {
        ...
        "decklist": {
            "pokemon": [
                { "count": 3, "name": "Mew ex", "set": "LM", "number": "88" },
                { "count": 3, "name": "Manectric ex", "set": "DX", "number": "101" },
                { "count": 4, "name": "Electrike", "set": "DX", "number": "60" },
                { "count": 1, "name": "Deoxys ex", "set": "EM", "number": "93" },
                { "count": 1, "name": "Girafarig", "set": "LM", "number": "16" },
                ...
                { "count": 12, "name": "Lightning Energy", "set": "HP", "number": "108" },
                { "count": 4, "name": "Multi Energy", "set": "EM", "number": "89" },
                { "count": 2, "name": "Unknown Card", "set": "FR", "number": "0" },
            ]
        }
    },
    {
    ...
    },
    {
        ...
        "decklist": {
            "pokemon": [
                ...
                { "count": 2, "name": "Pidgeotto", "set": "FL", "number": "45" },
                { "count": 3, "name": "Pidgey", "set": "FL", "number": "73" },
                {"count": 1, "name": "Houndoom", "set": "UF", "number": "7"},
{"count": 1, "name": "Houndour", "set": "TRR", "number": "59"},
                { "count": 1, "name": "Holon's Electrode", "set": "DS", "number": "21" },
            ], "trainer": [
                { "count": 4, "name": "Celio's Network", "set": "CG", "number": "73" },
                ...
                { "count": 1, "name": "Mr. Briney's Compassion", "set": "P2", "number": "8" },
                { "count": 4, "name": "Rare Candy", "set": "EM", "number": "83" },
                {"count": 3, "name": "Master Ball", "set": "DS", "number": "99"},
                { "count": 1, "name": "Pokémon Retriever", "set": "TRR", "number": "84" },
                { "count": 2, "name": "Space Center", "set": "DX", "number": "91" },
            ], "energy": [
                { "count": 6, "name": "Grass Energy", "set": "HP", "number": "105" },
                { "count": 4, "name": "Double Rainbow Energy", "set": "EM", "number": "87" },
                {"count": 3, "name": "Holon Energy WP", "set": "DF", "number": "86"},
                { "count": 1, "name": "Heal Energy", "set": "DX", "number": "94" },
                { "count": 1, "name": "Scramble Energy", "set": "DF", "number": "89" },
