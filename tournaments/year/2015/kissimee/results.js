let masters = [
    {
        ...
        "decklist": {
            "pokemon": [
                ...
                { "count": 3, "name": "Eevee", "set": "PLF", "number": "90" },
                { "count": 1, "name": "Eevee", "set": "FFI", "number": "80" },
                { "count": 2, "name": "Empoleon", "set": "DEX", "number": "29" },
                { "count": 2, "name": "Ditto", "set": "BCR", "number": "108" },
                { "count": 2, "name": "Jirachi-EX", "set": "PLB", "number": "60" },
                { "count": 2, "name": "Exeggcute", "set": "PLF", "number": "4" },
                { "count": 2, "name": "Audino", "set": "BCR", "number": "126" },
                { "count": 1, "name": "Slurpuff", "set": "PHF", "number": "69" },
                { "count": 1, "name": "Swirlix", "set": "PHF", "number": "68" },
                { "count": 1, "name": "Mr. Mime", "set": "PLF", "number": "47" },
            ], "trainer": [
                { "count": 3, "name": "Professor Juniper", "set": "BLW", "number": "101" },
                { "count": 1, "name": "Archie's Ace in the Hole", "set": "PRC", "number": "124" },
                { "count": 1, "name": "N", "set": "NVI", "number": "92" },
                { "count": 1, "name": "Lysandre", "set": "AOR", "number": "78" },
                ...
                { "count": 1, "name": "Training Center", "set": "FFI", "number": "102" },
            ], "energy": [
                { "count": 2, "name": "Water Energy", "set": "XY", "number": "134" },
                { "count": 1, "name": "Grass Energy", "set": "XY", "number": "132" },
    ...
    },
    {
        ...
        "decklist": {
            "pokemon": [
                ...
                { "count": 2, "name": "Lysandre", "set": "AOR", "number": "78" },
                { "count": 1, "name": "Lysandre's Trump Card", "set": "PHF", "number": "99" },
    ...
    },
    {
        ...
        "decklist": {
            "pokemon": [
                ...
                {"count": 1, "name": "Ninetales", "set": "PRC", "number": "21"},
                {"count": 1, "name": "Vulpix", "set": "PRC", "number": "20"},
                        ], "trainer": [
                            {"count": 4, "name": "Professor Juniper", "set": "BLW", "number": "101"},
                            {"count": 4, "name": "N", "set": "NVI", "number": "92"},
    ...
    },
    {
        ...
        "decklist": {
            "pokemon": [
                ...
                {"count": 3, "name": "Zubat", "set": "PLS", "number": "53"},
                ...
                {"count": 1, "name": "Jirachi-EX", "set": "PLB", "number": "60"},
                            ...
                            {"count": 2, "name": "Ultra Ball", "set": "PLB", "number": "90"},
        ...
        "decklist": {
            "pokemon": [
                ...
                {"count": 1, "name": "Jirachi-EX", "set": "PLB", "number": "60"},
                            ...
                            {"count": 4, "name": "Professor Juniper", "set": "BLW", "number": "101"},
                            {"count": 2, "name": "N", "set": "NVI", "number": "92"},
                            ...
                            {"count": 3, "name": "Muscle Band", "set": "XY", "number": "121"},
                            {"count": 3, "name": "Head Ringer Team Flare Hyper Gear", "set": "PHF", "number": "97"},
    ...
    },
    {
        ...
        "decklist": {
            "pokemon": [
                ...
                {"count": 2, "name": "Dialga-EX", "set": "PHF", "number": "62"},
                ...
                {"count": 1, "name": "Heatran", "set": "PHF", "number": "63"},
                            ...
                            {"count": 3, "name": "VS Seeker", "set": "PHF", "number": "109"},
                            {"count": 3, "name": "Ultra Ball", "set": "PLB", "number": "90"},
                            {"count": 2, "name": "Heavy Ball", "set": "NXD", "number": "88"},
                ...
                {"count": 8, "name": "Metal Energy", "set": "BLW", "number": "112"},
                {"count": 4, "name": "Double Colorless Energy", "set": "NXD", "number": "92"},
            ]
        }
    },
    ...
    },
    {
        ...
        "decklist": {
            "pokemon": [
                ...
                {"count": 1, "name": "Rayquaza", "set": "DRV", "number": "11"},
                        ], "trainer": [
                            {"count": 4, "name": "Professor Juniper", "set": "BLW", "number": "101"},
                            {"count": 4, "name": "N", "set": "NVI", "number": "92"},
