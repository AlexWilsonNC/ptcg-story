...
const expansiontable = document.querySelector('.expansion-table');
...
const enableDarkMode = () => {
    ...
    expansiontable.classList.add('darkon');
    italic.forEach((italic) => {
  ...
  const disableDarkMode = () => {
    ...
    expansiontable.classList.remove('darkon');
    italic.forEach((italic) => {
