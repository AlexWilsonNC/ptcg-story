...
// fetch('https://api.pokemontcg.io/v2/cards?q=set.id:smp').then(res => { console.log('Download New Set', res.json()) })

// promoSm.forEach(cardObject => {
...
// })
// console.log('Edited Set Object - Removing Values', promoSm)
