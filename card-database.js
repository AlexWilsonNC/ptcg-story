...
/* set */ fetch('https://api.pokemontcg.io/v2/cards?q=set.id:"sv7"').then(res => { console.log('Download New Set', res.json()) })
// /* set 250+ */ fetch('https://api.pokemontcg.io/v2/cards?q=set.id:swshp&page=2').then(res => { console.log('Download New Set', res.json()) })
