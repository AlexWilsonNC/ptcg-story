...
fetch('https://api.pokemontcg.io/v2/cards?q=set.id:pop2').then(res => { console.log('Download New Set', res.json()) })

pop1.forEach(cardObject => {
...
console.log('Edited Set Object - Removing Values', pop1)
